...
\node[vertex] at (0,0) (g3v1) {};
\node[vertex] at (1,1) (g3v2) {};
\draw (g3v2) to (g3v1);
\node[vertex] at (2,2) (g3v3) {};
\node[vertex] at (3,3) (g3v4) {};
\draw (g3v4) to (g3v3);
...
\draw[dashed,gray] (-0.75,3.5) to (-0.75,-0.5) to (3.75,-0.5) to (3.75,3.5) to (-0.75,3.5);

\begin{scope}[xshift=4.5cm]
\node[vertex] at (0,3) (g3v5) {};
\node[vertex] at (1,2) (g3v6) {};
\draw (g3v6) to (g3v5);
\node[vertex] at (2,1) (g3v7) {};
\node[vertex] at (3,0) (g3v8) {};
\draw (g3v8) to (g3v7);
\draw (g3v6.south) to [out=270,in=180] (g3v7.west);
\draw (g3v6.east) to [out=0,in=90] (g3v7.north);
\draw[dashed,gray] (-0.5,3.5) to (-0.5,-0.5) to (3.5,-0.5) to (3.5,3.5) to (-0.5,3.5);
\end{scope}
