...
\node at (2,1) (three) [vertex,label=left:$\scriptstyle 3$] {};
\node at (2,-1) (four) [vertex,label=right:$\scriptstyle 4$] {};
\node at (3,0) (five) [vertex,label=right:$\scriptstyle 5$] {};
\draw (one) to (two) to (three) to (five) to (four) to (two) to (five);
